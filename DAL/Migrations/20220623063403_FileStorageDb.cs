    ...
    public partial class FileStorageDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SysIdentityId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProfiles_AspNetUsers_SysIdentityId",
                        column: x => x.SysIdentityId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProfiles_UserStorage_UserStorageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StFile", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StorageAccessibility", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileAccessibility", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileAccessibility_StFile_FileId",
                        column: x => x.FileId,
                        principalTable: "StFile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileAccessibility_FileId",
                table: "FileAccessibility",
                column: "FileId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FileAccessibility_UserProfileId",
                table: "FileAccessibility",
                column: "UserProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_StFile_UserProfileId",
                table: "StFile",
                column: "UserProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_StFile_UserStorageId",
                table: "StFile",
                column: "UserStorageId");

            migrationBuilder.CreateIndex(
                name: "IX_StorageAccessibility_StorageId",
                table: "StorageAccessibility",
                column: "StorageId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StorageAccessibility_UserProfileId",
                table: "StorageAccessibility",
                column: "UserProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_SysIdentityId",
                table: "UserProfiles",
                column: "SysIdentityId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_UserStorageId",
                table: "UserProfiles",
                column: "UserStorageId",
                unique: true,
                filter: "[UserStorageId] IS NOT NULL");
        }
